...
> "And Hunt isn't only for staged code. Earlier today bounty #6 audited ChartChain — a separate live 0G project on Aristotle mainnet, MIT-licensed source. The per-CWE narrowing thesis, demonstrated against a real protocol. And forward-looking — same machinery, three faces, ordinary citizens. Insurance-claim-denial defense in `audits/insurance/` — 73 million ACA denials a year, the AI that denied them unverifiable. Disability and senior benefits defense in `audits/benefits/` — 330,000 SSDI cases waiting 274 days for a hearing, mostly elderly or disabled, mostly without a lawyer because the 25 percent contingency cap doesn't pencil. Medical Records Reader in `audits/medical/` — pathology disagrees with itself 14% of the time, radiology 20 to 32%, and no consumer AI today ships proof of which specialist saw which slide. Three faces of one primitive: Hunt defends citizens against *private-payor* opaque AI, defends them against *public-payor* opaque adjudication, and gives them *better* verifiable AI than they could otherwise afford. Sealed Inference is the anti-cheat substrate. 0G Storage is the privacy. 0G Chain is the settlement and reputation layer. Smart contracts is v1. Verifiable AI on private data — for whoever needs it — is the protocol."
