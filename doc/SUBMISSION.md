...
- **Beyond crypto — verifiable AI for ordinary citizens**: Hunt's primitives (sealed inference, multi-specialist competition, on-chain per-domain reputation) apply 1:1 to two non-crypto verticals positioned for v2:
  - **Insurance-claim-denial defense** ([`audits/insurance/README.md`](../audits/insurance/README.md)) — 73M ACA denials in 2023; <1% appealed; 40–75% appeal-success when they did. Three live AI-appeal products (Counterforce Health, Claimable, Fight Health Insurance) validated the category at 70–80% reversal without TEE attestation; all route patient records through OpenAI/Anthropic. Hunt closes that gap. Specialist subdomains (medical-necessity / coding-CPT / prior-auth / ERISA-procedural / state-external-review), regulatory framing (Colorado SB24-205/SB26-189, EU AI Act Annex III), and a synthetic denial letter modeled on the public *Estate of Lokken v. UnitedHealth* pleadings included.
  - **Medical Records Reader** ([`audits/medical/README.md`](../audits/medical/README.md)) — the cooperative face of the same primitive. Published per-specialty disagreement rates (14% major in general surgical pathology, 20-32% radiology oncologic CT, up to 52% neuro-oncology) make per-specialty reputation accrual *empirically calibrated* — a stronger claim than smart-contract CWE reputation can support. Scoped strictly as a "Records Reader" (surfaces questions to ask your physician, never diagnoses) inside 21st Century Cures CDS exemption + FDA Jan 2026 enforcement-discretion guidance. Includes a synthetic surgical-pathology report exhibiting the hardest interobserver call in breast biopsy (ADH vs. low-grade DCIS).

  Tier-A docs-only positioning for the May 2026 submission across both verticals; first on-chain bounty in each fires in v2 post-hackathon, once specialist briefs are tuned and validated against public corpora (denial letters for insurance; MIMIC-CXR / TCGA / NIH ChestX-ray14 for medical).
