// Canonical class registries for Hunt's verifiable-AI primitive.
//
// Smart-contract CWEs are copied from lib/cwe.js. The three non-crypto
// registries are copied from the v2 specialist brief scripts.
...
export function bytes32ToClass(hash, registry) {
  ...
  for (const c of registry) {
    if (classToBytes32(c).toLowerCase() === target) return c;
  }
  return undefined;
}
